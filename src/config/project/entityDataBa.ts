...
export const COMPONENT_NAMES = {
  ...
  AlarmHighOxygen: 'alarm_high_oxygen',
  AlarmLowOxygen: 'alarm_low_oxygen',
  AlarmHighPh: 'alarm_high_ph',
  AlarmLowPh: 'alarm_low_ph',
  AlarmHighTemperature: 'alarm_high_temperature',
  AlarmLowTemperature: 'alarm_low_temperature',
  AlarmLowWater: 'alarm_low_water',
  Pump: 'pump'
...
const EQUIPMENT_ENTITY_DATA: EntityData[] = [
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmHighTemperature,
    name: 'High Temeprature',
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmLowTemperature,
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmHighOxygen,
    name: 'High Oxygen',
    properties: getProperties(),
    isRoot: true,
    type: ENTITY_TYPES.Equipment
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmLowOxygen,
    name: 'Low Oxygen',
    properties: getProperties(),
    isRoot: true,
    type: ENTITY_TYPES.Equipment
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmHighPh,
    name: 'High pH',
    properties: getProperties(),
    isRoot: true,
    type: ENTITY_TYPES.Equipment
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmLowPh,
    name: 'Low pH',
    properties: getProperties(),
    isRoot: true,
    type: ENTITY_TYPES.Equipment
  ...
  {
    entityId: '9dc6a5c5-8b2b-4288-9d1e-a2823d4ac31f',
    componentName: COMPONENT_NAMES.AlarmLowWater,
    name: 'Low Water',
    properties: getProperties(),
    isRoot: true,
    type: ENTITY_TYPES.Equipment
